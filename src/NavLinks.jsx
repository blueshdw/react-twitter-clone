...
export const NavLinks = [
  {
    ...
    path: "/",
    ActiveIcon: (
      <div className="bg-transparent py-0.5 w-[48px] h-[50px] rounded-full flex items-center justify-center">
        <svg
          viewBox="0 0 24 24"
          width={26}
          height={26}
    ...
    InActiveIcon: (
      <div className="bg-transparent py-0.5 w-[48px] h-[50px] rounded-full flex items-center justify-center">
        <svg
          ...
          className="bg-transparent"
        >
          <g clipPath="url(#14-clip0_2592_269)" clipRule="evenodd">
            <path
              fill="#fff"
  ...
  },
  {
    id: 6,
    title: "Communities",
    path: `/${store.getState()?.Auth.currentAccount?.fullName}/communities/explore`,
    ActiveIcon: (
      <div className="bg-transparent py-0.5 w-[48px] h-[50px] rounded-full flex items-center justify-center">
        <svg
          viewBox="0 0 24 24"
  ...
  },
  {
    id: 7,
    title: "Profile",
    path: `/@${store.getState()?.Auth.currentAccount?.fullName}`,
    ActiveIcon: (
      <div className="bg-transparent py-0.5 w-[48px] h-[50px] rounded-full flex items-center justify-center">
        <svg
          viewBox="0 0 24 24"
